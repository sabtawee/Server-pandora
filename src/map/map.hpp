...
enum _sp {
	...
	SP_MAGIC_SUBDEF_ELE, SP_REDUCE_DAMAGE_RETURN, SP_MAGNUS_ALL_RACE // 2098-2099
};
...
extern bool agit4_flag;
#define is_agit_start() (agit_flag || agit2_flag || agit3_flag || agit4_flag)
...
inline bool mapdata_flag_vs(struct map_data *mapdata) {
	...
	if (mapdata->flag[MF_PVP] || mapdata->flag[MF_GVG_DUNGEON] || mapdata->flag[MF_GVG] || ((agit_flag || agit2_flag || agit4_flag) && mapdata->flag[MF_GVG_CASTLE]) || mapdata->flag[MF_GVG_TE] || (agit3_flag && mapdata->flag[MF_GVG_TE_CASTLE]) || mapdata->flag[MF_BATTLEGROUND])
		return true;
...
inline bool mapdata_flag_gvg(struct map_data *mapdata) {
	...
	if (mapdata->flag[MF_GVG] || ((agit_flag || agit2_flag || agit4_flag) && mapdata->flag[MF_GVG_CASTLE]) || mapdata->flag[MF_GVG_TE] || (agit3_flag && mapdata->flag[MF_GVG_TE_CASTLE]))
		return true;
